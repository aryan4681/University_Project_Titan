...
import src.main.calculations.solvers.HeunsSolver;

public class HeunsTest {
    ...
    public void testUpdatePositions_SingleObject() {
        ...
        HeunsSolver heun = new HeunsSolver();
        ...
        heun.updatePositions(system);

        // Verify that the position and velocity have been updated correctly
        double[] expectedPosition = new double[] { 144061.0, 180077.0, 216093.0 };
    ...
    public void testUpdatePositions_MultipleObjects() {
        ...
        double[] expectedPosition1 = new double[] { 4.830768e10, 9.919362e10, 2.695850e10 };
        double[] expectedVelocity1 = new double[] { 23.0672, 25.5272, 19.3211 };
        double[] expectedPosition2 = new double[] { 7.796376e10, 6.624584e10, 9.005302e10 };
        double[] expectedVelocity2 = new double[] { 22.1123, 17.3423, 27.9134 };

        Assert.assertArrayEquals(expectedPosition1, testObjects[1].getPosition(), 0.1e6);
        Assert.assertArrayEquals(expectedVelocity1, testObjects[1].getVelocity(), 0.0001);
        Assert.assertArrayEquals(expectedPosition2, testObjects[2].getPosition(), 0.1e6);
