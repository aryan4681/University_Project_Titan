...
public class EulerTest {
        ...
        public void testUpdatePositions_SingleObject() {
                ...
                // in our code we skip the first object of the list, so I added an object with 0
                // mass thus it does not influence the other object. Thus, it basically
        ...
        public void testUpdatePositions_MultipleObjects() {
                ...
                double[] expectedPosition1 = new double[] { 4.001384e10, 8.998468e10, 2.001159e10 };
                double[] expectedVelocity1 = new double[] { 23.0672, -25.5272, 19.3211 };
                double[] expectedPosition2 = new double[] { 6.998673e10, 6.001040e10, 8.001674e10 };
